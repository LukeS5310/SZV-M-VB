Public Module DB_OPERATIONS
    ...
    Public Sub CleanUP(Typ As CleanType)
        ...
        Select Case Typ
            Case CleanType.ALL
                DB.RunSimpleCmd("DELETE FROM MAN;DELETE FROM PE; DELETE FROM PAY_DO; DELETE FROM PAY_PO; DELETE FROM POPEN_DO; DELETE FROM POPEN_PO; DELETE FROM RECIP_DO;DELETE FROM DOPL_CHECK; DELETE FROM RECIP_PO;DELETE FROM IND4; DELETE FROM WPR")
                SetDBParam("PE_MD5", "0")
            ...
            Case CleanType.ONLY_DO_PO
                DB.RunSimpleCmd("DELETE FROM PAY_DO; DELETE FROM PAY_PO; DELETE FROM POPEN_DO; DELETE FROM POPEN_PO; DELETE FROM RECIP_DO; DELETE FROM RECIP_PO;DELETE FROM IND4;DELETE FROM DOPL_CHECK")
                SetDBStatus(0)
